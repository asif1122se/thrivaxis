 ...
 * Ready-to-paste React component. Works in Next.js (App or Pages router),
 * Vite, CRA — anything running React 18+. No dependencies.
 *
 *   import { ThrivAxisMark, ThrivAxisLogo } from "@/components/ThrivAxisLogo";
 *
 *   <ThrivAxisMark size={48} />                         // icon / favicon
 *   <ThrivAxisMark size={48} variant="white" glow />    // on dark backgrounds
 *   <ThrivAxisLogo height={40} />                        // full THRIVAXIS wordmark
 *   <ThrivAxisLogo height={40} variant="white" />        // wordmark on dark bg
 *
 * variant: "color" (metallic blue) | "white" (solid, for dark bg) | "mono" (single blue)
 *
