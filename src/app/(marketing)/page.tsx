  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden bg-bg text-ink">
      <div className="relative z-10">
        {/* Section 1: The Hook */}
        <section className="relative flex min-h-[100dvh] items-center overflow-hidden border-border/50 border-b px-6 pt-32 pb-12">
          ...
          <div className="container relative z-10 mx-auto flex max-w-7xl flex-col items-start justify-center">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/5 px-4 py-2 backdrop-blur-md">
            ...
            <KineticTypography
              ...
              className="max-w-3xl text-left font-display text-4xl leading-tight tracking-tight md:text-5xl lg:text-6xl"
            />
            <p className="mt-8 max-w-xl text-body-md text-muted/80 md:text-body-lg">
        ...
        <section className="relative flex flex-col items-center overflow-hidden border-border/50 border-b bg-bg py-8">
          <StackMarquee />
        </section>

        {/* Section 2: The Proof */}
        <section className="proof-section relative min-h-screen border-border/50 border-b bg-bg px-6 py-16 md:py-24">
          <div className="container mx-auto max-w-7xl">
            <h2 className="mb-12 text-center font-display text-display-sm md:mb-16 md:text-display-md">
              What we've built.
            </h2>
        ...
        <section className="relative min-h-screen border-border/50 border-t bg-surface-2 px-6 py-32">
          <div className="container mx-auto max-w-5xl space-y-32">
            <div className="playbook-item flex flex-col gap-12 md:flex-row md:items-center">
              <h2 className="font-display text-display-md md:w-1/2">Talk to your data.</h2>
              <p className="text-body-lg text-muted md:w-1/2">
            ...
            <div className="playbook-item flex flex-col gap-12 md:flex-row-reverse md:items-center">
              <h2 className="font-display text-display-md md:w-1/2">Automate the mundane.</h2>
              <p className="text-body-lg text-muted md:w-1/2">
            ...
            <div className="playbook-item flex flex-col gap-12 md:flex-row md:items-center">
              <h2 className="font-display text-display-md md:w-1/2">Products that create.</h2>
              <p className="text-body-lg text-muted md:w-1/2">
        ...
        <section className="relative border-border/50 border-y bg-bg px-6 py-24">
          <div className="container mx-auto max-w-7xl">
            <h2 className="mb-16 border-border border-b pb-6 text-left font-display text-display-xs md:text-display-sm">
              [ Core Capabilities ]
            </h2>
            <div className="grid grid-cols-1 gap-x-8 gap-y-16 md:grid-cols-2 lg:grid-cols-4">
              <div className="border-accent/30 border-l pl-6">
        ...
        <section className="process-section relative border-border/50 border-b bg-surface-3 px-6 py-24">
          <div className="container mx-auto max-w-4xl text-center">
            <KineticTypography
              text="From napkin sketch to intelligent product in weeks, not months."
              className="mb-12 justify-center font-display text-display-sm md:text-display-md"
            />
            <div className="grid grid-cols-1 gap-6 text-left md:grid-cols-3">
              <div className="process-step rounded-xl border border-border bg-bg p-8 shadow-glow transition-shadow hover:shadow-accent-glow">
        ...
        <section className="relative flex min-h-[60vh] items-center justify-center bg-bg px-6 pt-24 pb-48">
          <div className="relative z-10 mx-auto max-w-2xl rounded-3xl border border-border/30 bg-surface p-8 text-center shadow-[0_0_80px_-20px_var(--color-accent-glow)] md:p-12">
            <h2 className="mb-8 font-display text-display-md md:text-display-lg">
              Let's build your next era.
            </h2>
            <button
              type="button"
              className="rounded-full bg-accent px-8 py-4 font-medium text-base text-bg tracking-wide transition-all hover:scale-105 hover:opacity-90 md:px-10 md:py-5 md:text-lg"
            >
              Initialize Contact
            </button>
          </div>
